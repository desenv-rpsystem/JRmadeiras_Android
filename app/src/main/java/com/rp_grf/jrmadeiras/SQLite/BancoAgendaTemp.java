...
/**
 * Tabela temporária para gravar os dados da tela quando o usuario apertar o botão de salvar
 * Autor: André Castro
 */

public class BancoAgendaTemp extends SQLiteOpenHelper {

    private static final String DB_NAME = "banco_agenda_temp";
    ...
    public BancoAgendaTemp(Context context) {
    ...
    public ArrayList getFotosAntigo() {
    ...
    //Atualiza na tabela
    public void updateAgenda(Agenda tab_agenda) {
        ContentValues values = new ContentValues();
        //values.put("cod_age", tab_agenda.getCod_age());
        values.put("cod_pre_voo", tab_agenda.getCod_pre_voo());
        values.put("cod_cli", tab_agenda.getCod_cli());
        ...
        sqLiteDatabase.update(TABLE, values, "cod_age = " + tab_agenda.getCod_age().toString(), null);
    }
}
